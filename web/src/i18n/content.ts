...
const de = {
  ...
  submit: {
    ...
    hintRemove: "Hinweis entfernen",
    hintPlaceholder: "z. B. Unterstellhaus bei Gewitter an Bahn 5",
    hintKinds: {
      toilet: "Toiletten",
...
const en: Content = {
  ...
  submit: {
    ...
    hintAdd: "Add note",
    hintRemove: "Remove note",
    hintPlaceholder: "e.g. shelter from thunderstorms at hole 5",
    hintKinds: {
      toilet: "Toilets",
      shelter: "Shelter",
      drinks: "Drinks",
